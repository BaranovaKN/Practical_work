...
print("Пожалуйста вводите положение одной клетки(2 числа) через пробел за раз."
      ...
      "\n первое число - номер столбца\n второе - номер строки\n")
try:
    square_1 = tuple(map(int, input("Введите положение первой клетки: ").split()))
    square_2 = tuple(map(int, input("Введите положение второй клетки: ").split()))
